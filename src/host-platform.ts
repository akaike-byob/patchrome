...
export function detectHostPlatform(platform: NodeJS.Platform = process.platform, env: NodeJS.ProcessEnv = process.env, procVersion = readProcVersion): HostPlatform {
